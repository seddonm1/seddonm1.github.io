---
title: "Porter Stemming in Apache Spark ML"
date: 2015-12-13
draft: false
tags: ["development", "spark"]
---

As I have been playing with Apache Spark ML and needed a [stemming algorithm](https://en.wikipedia.org/wiki/Stemming) I decided to have a go and write a custom transformer myself.

As of Spark 1.5.2 Stemming has not been introduced ([should be in 1.7.0](https://issues.apache.org/jira/browse/SPARK-9578)) but I have taken the [Porter Stemmer](http://tartarus.org/martin/PorterStemmer/) Algorithm implemented in Scala by the [ScalaNLP](https://github.com/scalanlp/chalk) project and wrapped it as a Spark Transformer. Unfortunately, you are going to have to build Spark from source to use it.
...
On GitHub: [PorterStemmer.scala](https://github.com/seddonm1/spark/blob/master/mllib/src/main/scala/org/apache/spark/ml/feature/PorterStemmer.scala)
